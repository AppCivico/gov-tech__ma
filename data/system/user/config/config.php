...
$config['database'] = array(
    'expressionengine' => array(
        'hostname' => Manifest::get('DATABASE_HOSTNAME', ''),
        'database' => Manifest::get('DATABASE_DATABASE', ''),
        'username' => Manifest::get('DATABASE_USERNAME', ''),
        'password' => Manifest::get('DATABASE_PASSWORD', ''),
        'dbprefix' => 'exp_',
        'char_set' => 'utf8mb4',
