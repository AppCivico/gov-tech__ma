...
foreach ($domains as $site) {
    if (in_array(preg_replace("/^(homol|www\d*)\./", '', $domain), $site['hosts'])) {
...
$assign_to_config['global_vars']['global:not_sites'] = 'caema|cbm|detran|diario oficial|fapema|imesc|iprev|jucema|pm|policiacivil|procon|saude|seati|sefaz|segep|ssp';
